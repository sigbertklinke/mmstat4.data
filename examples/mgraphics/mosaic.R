...
thousand_songs$DECADE <- floor(as.numeric(thousand_songs$YEAR)/10) * 10
thousand_songs$BAND <- paste(thousand_songs$DECADE, "s", sep="")
thousand_songs$BAND[thousand_songs$DECADE < 1960] <- "1910s-50s"
